...
public class ParserUtilTest {
    ...
    private static final String VALID_SLACK = "rachelwalkerr";
    ...
    @Test
    public void parseSlack_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseSlack(INVALID_SLACK));
    }
    ...
    @Test
    public void parseSlack_validValueWithoutWhitespace_returnsSlack() throws Exception {
        Slack expectedAddress = new Slack(VALID_SLACK);
        assertEquals(expectedAddress, ParserUtil.parseSlack(VALID_SLACK));
    }
